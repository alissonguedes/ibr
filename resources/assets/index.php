...
<?php include "loading.php"; ?>
  ...
  <div id="slideshow-container">
    <div class="mySlides">
      <img src="img/slides/img1.jpg" alt="Image 1">
    </div>

    <div class="mySlides">
      <img src="img/slides/img2.jpg" alt="Image 2">
    </div>

    <div class="mySlides">
      <img src="img/slides/img3.jpg" alt="Image 3">
    </div>
  ...
  <!--base1-->
  <div class="base_slide"><img src="img/base_slide.png" class="img_cem"></div>

  <!--começo container-->
  <div class="container_index">

    <div class="apresentacao">
      <div class="img_ap"><img src="img/pastorwalber.png" class="img_cem"></div>
      <div class="text_ap">
        <div class="title_ap">O que acreditamos</div>
        <div class="sub_ap">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce magna massa.</div>
        <div class="resumo_ap">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce magna massa, condimentum at eleifend eu, semper a arcu. Phasellus dictum sem et urna malesuada pellentesque. Sed nisi enim, laoreet non justo id, commodo dapibus enim.</div>
      </div>
    </div>
    ...
    <section class="area_palavra">
      ...
      <div class="content">
        ...
        <div class="conj_palavra">
          <div class="img_palavra"><img src="img/palavra/001.jpg" class="img_cem"></div>
          <div class="datapastor">
            <div class="data">
              <div class="icon_p"><img src="img/icon_data.jpg" class="img_cem"></div>
              <div class="text_p">16 de outubro de 2023</div>
            </div>
            <div class="pastor">
              <div class="icon_p"><img src="img/icon_pastor.jpg" class="img_cem"></div>
              <div class="text_p">Pastor Walber</div>
            </div>
          </div>
          <div class="title_palavra">Disciplina na Igreja - Parte I</div>
          <div class="resumo_palavra">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce magna massa...</div>
      ...
      <a href="cultos.php"><div class="bt_ver_mais">ver mais</div></a>
    ...
    <section class="corpo_pastoral">
      ...
      <div class="content">
        ...
        <div class="conj_pastor">
          <div class="img_pr"><img src="img/pastor.jpg" class="img_cem"></div>
    ...
    <section class="eventos">
      ...
      <div class="content">
        ...
        <a href="evento_page.php">
          <div class="conj_palavra">
            <div class="img_palavra"><img src="img/eventos/001.jpg" class="img_cem"></div>
      ...
      <a href="eventos.php"><div class="bt_ver_mais2">ver todos os eventos</div></a>
    ...
    <section class="nossotemplo">
      ...
      <div class="img_templo">
        <img src="img/novotemplo.png" class="img_cem">
      </div>
