...
<x-slot:form action="{{ route('admin.paginas.agenda.post') }}" method="post" class="card-reveal no-padding" style="{{ $errors->any() || request('id') ? 'display: block; transform: translateY(-100%);' : 'display: none; transform: translateY(0%);' }}" enctype="multipart/form-data" autocomplete="off">
			...
			<div class="col row">
				...
				<div class="col s12">
					...
					<div class="row mb-3">
						...
						<label class="btn btn-flat transparent white-text">
