<div id="search-on-page">
	...
	<x-text-input type="search" id="input-search-header" :data-url="route('admin.paginas.agenda.cultos.index')" placeholder="Pesquisar eventos" autocomplete="off" />
</div>

<button type="button" class="btn btn-floating waves-effect gradient-45deg-green-light-green" data-href="{{ route('admin.paginas.agenda.cultos.index') }}" data-tooltip="Criar Agenda" data-trigger="form" data-target="main-form">
