...
<x-form action="{{ route('admin.paginas.agenda.cultos.index') }}" id="main-form" style="{{ $errors->any() || request()->routeIs('admin.paginas.agenda.cultos.disponibilidade') ? 'display: block;' : 'display: none;' }}">
		...
		<div class="row">
			<div class="col s12">
				<div class="input-field @error('medico') error @enderror">
					...
					@else
						{{-- <select name="medico" id="medico" class="autocomplete" data-url="{{ route('admin.paginas.agenda.cultos.busca.medico_especialidade') }}" placeholder="Buscar por especialidade ou médico"></select> --}}
		...
		<div class="row">
			<div class="col s12">
				<div class="input-field @error('clinica') error @enderror">
					...
					{{-- <select name="clinica" id="clinica" data-url="{{ route('admin.paginas.agenda.cultos.medico.get_clinicas', request('id_medico')) }}" disabled> --}}
...
<x-form id="form-agendamento" style="{{ $errors->any() || request()->routeIs('admin.paginas.agenda.cultos.medico.agendamento') ? 'display: block;' : 'display: none;' }}">
