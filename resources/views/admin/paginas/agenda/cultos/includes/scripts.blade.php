				...
				$(this).find('.horario').find('.time-range').each(function(index) {
					...
					<div class="time-range">
						<div class="input-field m-0 mb-1">
							...
							<div class="acao">
								<button type="button" class="btn btn-small btn-flat btn-floating transparent white-text" data-trigger="delete_time">
									<i class="material-symbols-outlined">block</i>
								</button>
								<button type="button" class="btn btn-small btn-flat btn-floating transparent white-text hide" data-trigger="add_time">
...
<style>
	...
	.day-range .acao button i {
		color: var(--grey-lighten-1) !important;
		font-size: 24px;
		font-weight: 300;
	}

	.day-range .acao button:disabled i {
