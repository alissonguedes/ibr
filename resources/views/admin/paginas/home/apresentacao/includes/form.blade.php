...
<form action="{{ route('admin.paginas.home.apresentacao.post') }}" method="post" class="card card-panel animated fadeIn" style="display: block; transform: translateY(0%);" enctype="multipart/form-data" autocomplete="off">
