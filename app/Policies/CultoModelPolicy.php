...
class CultoModelPolicy
{
	 ...
	 */
	public function view(User $user, PastorModel $pastorModel): bool
	{
		return $user->nivel === 'root' || $user->nivel === 'admin' || $user->nivel === 'pastor';
	}
	 ...
	 */
	public function update(User $user, PastorModel $pastorModel): bool
	{
		return $user->nivel === 'root' || $user->nivel === 'admin' || $user->nivel === 'pastor';
	}
	 ...
	 */
	public function delete(User $user, PastorModel $pastorModel): bool
	{
		return $user->nivel === 'root' || $user->nivel === 'admin' || $user->nivel === 'pastor';
	}
